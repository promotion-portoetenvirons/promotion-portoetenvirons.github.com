...
List of necessary applications to get the site running
------------------------------------------------------

1. Github for windows
2. Jekyll
3. [FileZilla](http://www.netfox2.net/modules/wfdownloads/singlefile.php?cid=20&lid=279#.U7BBo7HX3IU)
4. [Notepad++](http://notepad-plus-plus.org/download/v6.6.7.html)

How to Run Github on Windows
----------------------------
...
Download [FileZilla](http://www.netfox2.net/modules/wfdownloads/singlefile.php?cid=20&lid=279#.U7BBo7HX3IU)

Install it and identify yourself with the identifiers sent by email.
